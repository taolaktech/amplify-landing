  ...
  const plans = [
    {
      ...
      features: [
        ...
        "AI-generated concepts, offers, scripts, ad copy, and images",
        "Connect all channels + run automated ads on Google, Facebook & Instagram",
        "Unlimited ad spend",
    ...
    },
    {
      ...
      features: [
        ...
        "5,000 AI credits for higher ad volume",
      ],
